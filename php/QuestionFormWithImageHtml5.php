  ...
  <section class="main" id="s1">
    <div id="divA">
      <form id="galderenF" name="galderenF" action="AddQuestion.php" method="post">
		...
		<input type="email" id="email" name="email" required pattern="([a-z]+[0-9]{3}@ikasle\.ehu\.(eus|es))|([a-z]+(\.[a-z]+)?@ehu\.(eus|es))"><span class="derrigorrezkoa"> *</span><br><br>
      	<label for="galdera">Galdera:</label>
		<input type="text" id="galdera" name="galdera" required minlength="10"><span class="derrigorrezkoa"> *</span><br><br>
        ...
        <input type="file" id="img" name="img" accept="image/*" onchange="loadFile(event)" required><br>
